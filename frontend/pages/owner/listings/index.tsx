...
export default function OwnerListings() {
  ...
  const [deleteStep, setDeleteStep] = useState<"confirm" | "password" | "oauth">("confirm");
  ...
  const handleOAuthDelete = async () => {
    ...
    try {
      ...
      // If no error, the page will redirect to Google then back
    } catch {
  ...
  // Handle OAuth redirect callback for deletion
  useEffect(() => {
              ...
              {deleteStep === "confirm" ? (
                ...
                <>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
                      Since you signed in with {oauthProvider === "google" ? "Google" : oauthProvider}, please sign in again to confirm the deletion.
                    </p>
                  </div>
                  {deleteError && (
                    ...
                    >
                      {deleting ? (
                        ...
                        <>
                          ...
                          Sign in with {oauthProvider === "google" ? "Google" : oauthProvider} to delete
                        </>
                      )}
                    </button>
                  </div>
