            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="mt-6 p-5 rounded-2xl bg-[var(--color-primary)] from-[var(--color-primary-50)] to-[var(--color-primary-50)] dark:from-primary-900/20 dark:to-[var(--color-surface-muted)] border border-[var(--color-primary-soft)] dark:border-primary-900/40">
                ...
                <div className="flex flex-wrap gap-2">
                  <Link
                    href="/support/tickets"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-500)] text-[color:var(--color-primary-fg)] rounded-lg text-xs font-semibold transition-colors"
                  >
          ...
          <div className="hidden lg:block">
            <div className="sticky top-6 space-y-4">
              ...
              <div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface-2)] p-4">
                ...
                <Link
                  href="/support/tickets"
                  className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-[var(--color-primary)] hover:bg-[var(--color-primary-500)] text-[color:var(--color-primary-fg)] rounded-xl text-xs font-semibold transition-colors"
                >
                  <MessageCircle className="w-3.5 h-3.5" />
                  Get help
                </Link>
