        ...
        <div className="bg-[var(--color-surface-2)] border border-[var(--color-line)]/70 dark:border-slate-800 p-8 rounded-2xl">
          ...
          {sent ? (
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="bg-[var(--color-accent-soft)] dark:bg-[var(--color-accent)]/10 border border-[var(--color-accent-soft)] dark:border-[var(--color-accent-soft)] rounded-xl p-4 text-center">
                <div className="w-10 h-10 rounded-full bg-[var(--color-accent-soft)] dark:bg-[var(--color-accent)]/20 flex items-center justify-center mx-auto mb-3">
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-sm text-[var(--color-ink-3)]">
                ...
                <Link href="/magic-link-signup" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] font-semibold transition-colors">
