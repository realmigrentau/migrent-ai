          ...
          <section className="card p-6 rounded-2xl space-y-3">
            ...
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
              ...
              <ul className="list-disc list-inside space-y-1.5">
                ...
                <li><strong>Email</strong> &mdash; Contact <a href="mailto:migrentau@gmail.com" className="text-rose-500 hover:text-rose-600 dark:hover:text-rose-400 underline underline-offset-2 transition-colors">migrentau@gmail.com</a></li>
