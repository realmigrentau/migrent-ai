...
export default function AntiDiscrimination() {
  return (
    <>
      <Head>
        <title>Fair Housing Policy | MigRent AI</title>
        <meta name="description" content="MigRent AI Fair Housing Policy - our commitment to anti-discrimination and equal access to accommodation." />
      </Head>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black tracking-tight text-slate-900 dark:text-white">
                Fair Housing <span className="gradient-text">Policy</span>
              </h1>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="space-y-8">
          ...
          <section className="card p-6 rounded-2xl space-y-3 border-l-4 border-l-pink-500">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Our Commitment</h2>
          ...
          <section className="card p-6 rounded-2xl space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Protected Attributes Under Australian Law</h2>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
          ...
          {/* Prohibited Conduct */}
          <section className="card p-6 rounded-2xl space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Prohibited Conduct on MigRent</h2>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
          ...
          {/* Lawful Exceptions */}
          <section className="card p-6 rounded-2xl space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Lawful Exceptions</h2>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
          ...
          {/* How to Report */}
          <section className="card p-6 rounded-2xl space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Reporting Discrimination</h2>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
          ...
          {/* Consequences */}
          <section className="card p-6 rounded-2xl space-y-3">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Consequences</h2>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3">
