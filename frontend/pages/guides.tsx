...
const guides = [
  ...
  },
  {
    ...
    gradient: "from-[var(--color-warn-500)] to-[var(--color-coral-500)]",
  ...
  },
  {
    ...
    color: "text-[var(--color-accent)]",
    bgColor: "bg-[var(--color-accent-soft)] dark:bg-[var(--color-accent)]/10",
  ...
  },
  {
    ...
    bgColor: "bg-[var(--color-danger-50)] dark:bg-[var(--color-danger-500)]/10",
    ...
    <>
      ...
      <div className="space-y-20">
        ...
        <section className="relative text-center py-20 overflow-hidden">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[var(--color-primary)]/12 dark:bg-[var(--color-primary)]/6 hidden " />
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-[var(--color-accent)]/12 dark:bg-[var(--color-accent)]/6 hidden " style={{ animationDelay: "1s" }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[var(--color-primary)]/5 hidden " />
        ...
        <section>
          ...
          >
            <div className="group relative rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface-2)] overflow-hidden hover:shadow-xl transition-all duration-300">
              ...
              >
                <Link href={`/guides/${guide.id}`}>
                  <motion.div
                    ...
                    className="group relative rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface-2)] overflow-hidden hover:shadow-lg transition-all duration-300 h-full flex flex-col cursor-pointer"
                  >
                    {/* Top gradient accent */}
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[10px] text-[var(--color-ink-3)]">{guide.readTime}</span>
                          </div>
                        </div>
                      </div>
        ...
        <section>
          ...
          >
            <div className="rounded-2xl bg-[var(--color-surface-2)] p-8 md:p-10 flex flex-col md:flex-row items-center gap-6">
              <div className="w-14 h-14 rounded-2xl bg-[var(--color-primary-50)] dark:bg-[var(--color-primary)]/10 flex items-center justify-center shrink-0">
