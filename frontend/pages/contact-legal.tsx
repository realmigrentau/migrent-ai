    ...
    <>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black tracking-tight text-slate-900 dark:text-white">
                Legal Contact &amp; <span className="gradient-text">Arbitration</span>
              </h1>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="space-y-8">
          ...
          {/* CTA */}
          <div className="card p-6 rounded-2xl bg-gradient-to-br from-cyan-50 to-cyan-100/50 dark:from-cyan-500/10 dark:to-cyan-600/5 border-cyan-200 dark:border-cyan-500/20 text-center">
