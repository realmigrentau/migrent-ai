          ...
          {activeThread ? (
            <>
              ...
              <div
                ...
                className="flex-1 overflow-y-auto px-6 pt-5 pb-3 messages-scroll bg-[var(--color-surface-muted)]"
              >
                {messagesLoading ? (
                  ...
                  <>
                    ...
                    <div className="flex justify-center mb-5">
                      <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--color-surface-sunk)] text-[var(--color-ink-3)]">
                        <Shield className="w-2.5 h-2.5" />
                        <span className="text-[10.5px] font-semibold uppercase tracking-[0.04em] font-mono">
                          Private · {activeThread.other_user_name}
                        </span>
                      </div>
                    </div>
                    ...
                    <AnimatePresence>
                      {isOtherTyping && (
                        ...
                        >
                          <div className="px-3.5 py-2.5 bg-[var(--color-surface)] border border-[var(--color-line)] rounded-[14px] rounded-bl-[4px]">
                            <div className="flex items-center gap-1">
                              <div className="w-1.5 h-1.5 rounded-full bg-[var(--color-ink-3)] animate-bounce" style={{ animationDelay: "0ms" }} />
                              <div className="w-1.5 h-1.5 rounded-full bg-[var(--color-ink-3)] animate-bounce" style={{ animationDelay: "150ms" }} />
                              <div className="w-1.5 h-1.5 rounded-full bg-[var(--color-ink-3)] animate-bounce" style={{ animationDelay: "300ms" }} />
                            </div>
                          </div>
