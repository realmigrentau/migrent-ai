      ...
      <div className="space-y-14">
        ...
        <section className="grid sm:grid-cols-3 gap-4">
          <a href="#contact-form" className="card p-6 rounded-2xl text-left hover:border-rose-200 dark:hover:border-rose-500/30 transition-colors block">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-white text-base mb-1.5">I need help</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Account, listing, booking, payment - send a message and we'll reply within 24h.</p>
          </a>

          <a href="#help-shortcut" className="card p-6 rounded-2xl text-left hover:border-amber-200 dark:hover:border-amber-500/30 transition-colors block">
            <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="font-semibold text-slate-900 dark:text-white text-base mb-1.5">I have a question</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Most answers are in our Help Center. Browse first - it's faster.</p>
          </a>
          ...
          <a href="#escalation" className="card p-6 rounded-2xl text-left hover:border-red-200 dark:hover:border-red-500/30 transition-colors block">
            <div className="w-10 h-10 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.008v.008H12v-.008z" />
              </svg>
            </div>
            <h3 className="font-semibold text-slate-900 dark:text-white text-base mb-1.5">Safety, legal or press</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Report a user, formal legal notice, or media enquiry - jump straight to the right channel.</p>
          </a>
        </section>
        ...
        <section id="contact-form" className="grid lg:grid-cols-5 gap-6">
          <div className="lg:col-span-2 space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">Send us a message</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
              Tell us what's going on. We reply from <span className="font-medium text-slate-900 dark:text-white">migrentau@gmail.com</span> within 24 hours on weekdays, 48 hours on weekends.
            </p>
            <div className="card-subtle p-4 rounded-xl space-y-2 text-sm">
              <p className="font-semibold text-slate-800 dark:text-slate-200">Prefer email?</p>
              <a
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                For faster routing, add a tag to your subject line - for example <span className="font-mono text-xs bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">[BOOKING]</span> or <span className="font-mono text-xs bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">[SAFETY]</span>.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Got it - your message is in.</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
                  We'll reply to <span className="font-medium text-slate-900 dark:text-white">{email}</span> from <span className="font-medium text-slate-900 dark:text-white">migrentau@gmail.com</span> within 24 hours on weekdays.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
              ...
              <form onSubmit={handleSubmit} className="card p-6 md:p-7 rounded-2xl space-y-5" noValidate>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="name" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1.5">Full name</label>
                    <input
                      id="name"
                      type="text"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="category" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1.5">Enquiry type</label>
                    <select
                      id="category"
                      value={category}
                    ...
                    {activeHelper && <p className="text-xs text-slate-500 dark:text-slate-400 mt-1.5">{activeHelper}</p>}
                  </div>
                  <div>
                    <label htmlFor="subject" className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1.5">Subject <span className="text-slate-400 font-normal">(optional)</span></label>
                    <input
                      id="subject"
                      type="text"
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label htmlFor="message" className="block text-xs font-medium text-slate-700 dark:text-slate-300">Message</label>
        ...
        <section id="escalation" className="grid md:grid-cols-2 gap-4">
          <div className="card p-6 rounded-2xl border-l-2 border-l-red-500">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-base">Safety or report a user</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Scams, harassment, suspicious listings.</p>
              </div>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
              Use the <span className="font-medium text-slate-900 dark:text-white">Report</span> button on any listing or profile, or email us with the subject line <span className="font-mono text-xs bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">[SAFETY]</span>. We respond within 24 hours, 7 days a week.
            </p>
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=migrentau@gmail.com&su=%5BSAFETY%5D"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-red-600 dark:text-red-400 hover:text-red-700"
            >
          ...
          <div className="card p-6 rounded-2xl border-l-2 border-l-cyan-500">
            <div className="flex items-start gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-100 dark:border-cyan-500/20 flex items-center justify-center shrink-0">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-base">Legal, privacy or DMCA</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Formal notices, data requests, arbitration.</p>
              </div>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <Link
              href="/contact-legal"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-700"
            >
              Open Legal Contact
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold tracking-tight text-slate-900 dark:text-white">Other ways to reach us</h2>
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Press &amp; media</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Subject: <span className="font-mono">[PRESS]</span> · 3-5 business days</p>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="card p-5 rounded-2xl block hover:border-blue-200 dark:hover:border-blue-500/30 transition-colors"
            >
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Partnerships</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Universities, mentors, integrations</p>
            </a>
        ...
        <section className="grid md:grid-cols-2 gap-4">
          <div className="card p-6 rounded-2xl space-y-2">
            <h3 className="font-semibold text-slate-900 dark:text-white text-base">Business details</h3>
            <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-1 pt-1">
          ...
          <div className="card p-6 rounded-2xl">
            <h3 className="font-semibold text-slate-900 dark:text-white text-base mb-2">A note from the founder</h3>
