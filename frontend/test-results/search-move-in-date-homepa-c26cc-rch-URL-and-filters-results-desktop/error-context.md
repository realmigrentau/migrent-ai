...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    20 × unexpected value "http://127.0.0.1:3100/seeker/search?suburb=Kellyville&checkIn=2026-10-17&maxPrice=350"
...
- main:
  ...
  - complementary "Filters":
    - search "Room filters":
      ...
      - group "Search by":
        - button "Near me"
        - button "suburb" [pressed]
        - button "postcode"
        - button "address"
      - text: Suburb or city
      - searchbox "Suburb or city": Kellyville
      - button "Price range ($/week)" [expanded]
      - text: Minimum weekly price
      - spinbutton "Minimum weekly price"
      - text: Maximum weekly price
      - spinbutton "Maximum weekly price": "350"
      - button "Room type" [expanded]
      - button "All" [pressed]
      - button "Private room"
      - button "Shared room"
      - button "Entire place"
      - button "Property type"
      - button "Dates" [expanded]
      - text: Move in
      - textbox "Move in": 2026-10-17
      - text: Move out
      - textbox "Move out"
      - button "Guests"
      - button "Near a station"
      - button "Minimum stay"
      - button "Amenities & features" [expanded]
      - button "Furnished"
      - button "Bills included"
      - button "Instant book"
      - button "Pets allowed"
      - button "Parking"
      - button "Air con"
  ...
  - status:
    - paragraph: Map unavailable
    - paragraph: The map could not load. Results are listed below.
    - button "Try the map again"
- contentinfo:
