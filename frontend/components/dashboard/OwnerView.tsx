  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card overflow-hidden">
        <div className="p-4 md:p-5 border-b border-[var(--color-line)]/50">
        ...
        {loading ? (
          ...
          <div className="p-10 text-center">
            ...
            <p className="text-sm text-[var(--color-ink-3)] mb-4 max-w-xs mx-auto">
            ...
            {listings.slice(0, 5).map((listing: any, i: number) => (
              ...
              >
                ...
                >
                  ...
                  {/* Views */}
                  <div className="col-span-2 flex items-center gap-1 text-sm text-[var(--color-ink-3)]">
