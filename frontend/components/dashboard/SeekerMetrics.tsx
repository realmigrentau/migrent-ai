...
import type { SeekerMetrics as SeekerMetricsType } from "../../hooks/useSeekerData";

interface Props {
  metrics: SeekerMetricsType | null;
  loading: boolean;
}
...
export default function SeekerMetrics({ metrics, loading }: Props) {
  return (
