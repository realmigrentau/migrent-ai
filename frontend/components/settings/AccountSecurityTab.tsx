    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="font-bold text-[var(--color-ink)]">Email Address</h3>
              <StatusBadge status="verified" label="Verified" />
            </div>
            <p className="text-sm text-[var(--color-ink-2)] break-all">{user?.email}</p>
          </div>
        </div>
      </GlassCard>
      ...
      <GlassCard delay={0.1}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-bold text-[var(--color-ink)] mb-1">Account ID</h3>
            <div className="flex items-center gap-2">
              ...
              >
                {copied ? (
                  ...
                  <Copy className="w-4 h-4 text-[var(--color-ink-3)]" />
                )}
              </button>
            </div>
            <p className="text-xs text-[var(--color-ink-3)] mt-1.5">Use this ID for support requests</p>
          </div>
        </div>
      </GlassCard>
      ...
      {isGoogleOnlyUser && !hasPassword && (
        <GlassCard delay={0.12} gradient="emerald">
          <div className="flex items-start gap-4 mb-5">
            ...
            <div>
              <h3 className="font-bold text-[var(--color-ink)]">Set a Password</h3>
          ...
          <div className="space-y-3 ml-14">
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-[var(--color-ink-3)] hover:text-[var(--color-ink-2)] dark:hover:text-[var(--color-ink-4)] transition-colors"
              >
      ...
      <GlassCard delay={0.15}>
        <div className="flex items-start gap-4 mb-5">
          ...
          <div>
            <h3 className="font-bold text-[var(--color-ink)]">Change Password</h3>
            <p className="text-xs text-[var(--color-ink-3)]">Secure your account with a strong password</p>
          </div>
        </div>
      ...
      <GlassCard delay={0.2}>
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            <h3 className="font-bold text-[var(--color-ink)]">Login Methods</h3>
            <p className="text-xs text-[var(--color-ink-3)]">Connected accounts & login options</p>
          </div>
        </div>
        ...
        <div className="ml-14 space-y-3">
          ...
          <div className="flex items-center justify-between p-3 rounded-xl border border-[var(--color-line)] bg-[var(--color-surface)]/50 dark:bg-[var(--color-surface-muted)]/30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-[var(--color-ink-2)]">Google</span>
            </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-xl border border-[var(--color-line)] bg-[var(--color-surface)]/50 dark:bg-[var(--color-surface-muted)]/30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-[var(--color-ink-2)]">Magic Link</span>
            </div>
      ...
      <GlassCard delay={0.25}>
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            <h3 className="font-bold text-[var(--color-ink)]">Active Sessions</h3>
            <p className="text-xs text-[var(--color-ink-3)]">Devices where you're currently logged in</p>
          </div>
        </div>
        ...
        <div className="ml-14 space-y-3">
          {sessions.map((s) => (
            <div
              key={s.id}
              className="flex items-center justify-between p-3 rounded-xl border border-[var(--color-line)] bg-[var(--color-surface)]/50 dark:bg-[var(--color-surface-muted)]/30"
            >
              <div className="flex items-center gap-3">
                {s.device.includes("Mobile") || s.device.includes("iPhone") ? (
                  <Smartphone className="w-5 h-5 text-[var(--color-ink-3)]" />
                ) : (
                  <Monitor className="w-5 h-5 text-[var(--color-ink-3)]" />
                )}
                <div>
                  <p className="text-sm font-medium text-[var(--color-ink-2)]">{s.device}</p>
                  <p className="text-xs text-[var(--color-ink-3)]">{s.location} · {s.lastActive}</p>
                </div>
              </div>
              {s.current ? (
      ...
      <GlassCard delay={0.3} gradient="rose">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            <h3 className="font-bold text-[var(--color-danger-500)] dark:text-[var(--color-danger-500)]">Danger Zone</h3>
            <p className="text-xs text-[var(--color-ink-3)]">Permanent actions - cannot be undone</p>
          </div>
        </div>
          ...
          <div className="p-4 rounded-xl border border-[var(--color-danger-500)]/30 dark:border-[var(--color-danger-500)]/20 bg-[var(--color-danger-50)]/50 dark:bg-[var(--color-danger-500)]/5">
            ...
            <AnimatePresence>
              {showDeleteConfirm && (
                ...
                >
                  <div className="space-y-3 mt-3 pt-3 border-t border-[var(--color-danger-500)]/30 dark:border-[var(--color-danger-500)]/20">
                    <p className="text-xs text-[var(--color-danger-600)] dark:text-[var(--color-danger-500)]">
