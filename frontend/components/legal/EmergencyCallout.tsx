...
export default function EmergencyCallout({
  ...
  return (
    <div className="card p-5 rounded-2xl border-l-4 border-l-red-500 bg-red-50/50 dark:bg-red-500/5 space-y-3">
      ...
      {note && (
        <p className="text-xs text-slate-500 dark:text-slate-400 pt-1">{note}</p>
      )}
    </div>
  );
}
