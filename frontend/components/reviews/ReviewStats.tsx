    ...
    <div className="space-y-3">
      ...
      {stats.avg_migrant_friendliness != null && Number(stats.avg_migrant_friendliness) > 0 && (
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-teal-50 dark:bg-teal-500/10 text-xs font-medium text-teal-700 dark:text-teal-300">
