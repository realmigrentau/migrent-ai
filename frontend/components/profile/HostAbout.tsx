  ...
  return (
    <div className="space-y-6">
      ...
      {profile.lifestyle.length > 0 && (
        <div>
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2.5">Lifestyle</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {profile.interests.length > 0 && (
        <div>
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2.5">Interests</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {(profile.social_twitter || profile.social_facebook || profile.social_linkedin) && (
        <div>
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2.5">Connect</h4>
          <div className="flex items-center gap-3">
            {profile.social_twitter && (
              <a href={profile.social_twitter} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 hover:text-sky-500 hover:border-sky-200 dark:hover:border-sky-500/30 hover:scale-110 transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
            )}
            {profile.social_facebook && (
              <a href={profile.social_facebook} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 hover:text-blue-600 hover:border-blue-200 dark:hover:border-blue-500/30 hover:scale-110 transition-all">
            ...
            {profile.social_linkedin && (
              <a href={profile.social_linkedin} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 hover:text-blue-700 hover:border-blue-200 dark:hover:border-blue-500/30 hover:scale-110 transition-all">
