              ...
              {!isOwnProfile ? (
                <>
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold bg-white text-slate-900 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all"
                  >
