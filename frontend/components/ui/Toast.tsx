...
const VARIANT_STYLES: Record<ToastVariant, string> = {
  success:
    "bg-[var(--color-accent-50)]/95 dark:bg-[var(--color-accent)]/15 border-[var(--color-accent-100)] dark:border-emerald-500/30 text-emerald-900 dark:text-emerald-100",
  error:
  ...
  warning:
    "bg-[var(--color-warn-50)]/95 dark:bg-[var(--color-warn-500)]/15 border-[var(--color-line-2)] dark:border-amber-500/30 text-[var(--color-warn-600)] dark:text-amber-100",
};
...
const ICON_BG: Record<ToastVariant, string> = {
  ...
  warning: "bg-[var(--color-warn-500)] text-white",
};
