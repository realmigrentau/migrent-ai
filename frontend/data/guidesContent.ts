// ─── Guide content data for MigRent ────────────────────────────────────
...
const guidesContent: GuideContent[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Remember that MigRent charges a small service fee on each booking. This fee covers payment processing, dispute resolution support, and platform maintenance. The fee is displayed transparently before you publish your listing so there are no surprises.",
        ],
      ...
      },
      {
        ...
        tip: "Translate your house rules into the languages most common among your expected seekers. MigRent can auto-translate rules into over 40 languages with one click.",
      },
      {
        id: "welcome-seeker",
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Learn how to use MigRent's smart filters, alerts, and one-click apply to find the perfect room before you even land in Australia.",
    ...
    sections: [
      {
        ...
        tip: "If you are arriving on a student visa, use the \"Near University\" filter and enter your institution's name. MigRent will automatically surface rooms within a thirty-minute commute.",
      },
      {
        id: "enable-alerts",
      ...
      },
      {
        ...
        content: [
          ...
          "You can compare up to four suburbs side by side on the comparison screen, which is especially useful if you are weighing trade-offs between affordability and commute time. MigRent also provides a brief neighbourhood profile for each suburb covering demographics, popular cuisines, safety ratings, and community vibe.",
        ],
      ...
      },
      {
        ...
        content: [
          ...
          "You can track all your active applications from the \"My Applications\" tab on your dashboard. Each application shows its current status: sent, viewed by host, shortlisted, accepted, or declined. If a host has not responded within 48 hours, MigRent sends them a gentle reminder on your behalf.",
        ],
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Complete MigRent's identity verification process to earn your trust badge and unlock priority features.",
    ...
    sections: [
      {
        ...
        content: [
          "MigRent accepts a range of identity documents to accommodate migrants at different stages of their Australian journey. You can upload your passport, Australian driver's licence, state-issued photo ID, or ImmiCard. If you have recently arrived and only have your passport, that is perfectly fine as a starting point.",
      ...
      },
      {
        ...
        tip: "A confirmed Australian address boosts your profile completeness to 100% and can increase your application acceptance rate by up to 40% according to MigRent platform data.",
      },
      {
        id: "trust-badge",
        ...
        content: [
          ...
          "Verification is a one-time process and your badge remains active for the duration of your MigRent account. If you update your identity document (for example, after receiving a new visa or permanent residency), you may be asked to re-verify to keep your badge current.",
        ],
        tip: "Hosts on MigRent are three times more likely to accept applications from seekers with a trust badge. Completing verification before you start applying is well worth the five minutes it takes.",
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Upload at least six photos in the following order: bedroom (wide angle from doorway), bedroom (detail shot of desk or storage), bathroom, kitchen, common living area, and exterior or street view. MigRent uses the first photo as the listing thumbnail, so make it your strongest and most inviting shot.",
      ...
      },
      {
        ...
        content: [
          ...
          "Consider implementing seasonal pricing if your area experiences demand fluctuations. University suburbs often see higher demand from January to March (start of academic year) and July (mid-year intake), while holiday destinations peak during December and January. MigRent lets you set different rates for up to four seasonal periods per year.",
        ...
        tip: "Check the MigRent earnings calculator before setting your price. It shows you how your rate compares to the suburb median and estimates your annual income based on an average occupancy rate.",
      },
      {
        id: "availability-settings",
        title: "Availability Settings",
        content: [
          "Your availability calendar controls when your room can be booked. You can set a minimum stay length (MigRent recommends at least four weeks for the best host and seeker experience), a maximum stay length, and specific date ranges when the room is unavailable.",
        ...
        tip: "Enable Instant Book for verified seekers to increase your booking rate. Data from MigRent shows that Instant Book listings receive 60% more confirmed bookings than Request to Book listings.",
      },
      {
        id: "publish-go-live",
        title: "Publish and Go Live",
        content: [
          "Before publishing, MigRent runs a completeness check on your listing. This review ensures you have filled in all required fields, uploaded the minimum number of photos, and set a price within a reasonable range for your suburb. If anything is missing, you will see specific prompts to fix each issue.",
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Unlock the prestigious Superhost badge by meeting MigRent's quality benchmarks for ratings, response time, reliability, and booking volume.",
    ...
    sections: [
      {
        ...
        content: [
          "Your overall rating is the single most important factor in earning and retaining Superhost status. MigRent calculates your rating as a rolling average of your last twenty reviews. To qualify as a Superhost, you need an average rating of 4.8 out of 5.0 or higher.",
      ...
      },
      {
        ...
        content: [
          "MigRent tracks your average response time to new messages and booking requests. To maintain Superhost status, your median response time must be under one hour during your active hours. Active hours are defined as the window you set in your host settings (for example, 8 am to 10 pm).",
          "Enable push notifications on your phone and set up the MigRent quick-reply templates to respond faster. The platform provides pre-written responses for common enquiries such as check-in instructions, transport directions, and house rules summaries. You can customise these templates and send them with a single tap.",
      ...
      },
      {
        ...
        content: [
          ...
          "To avoid cancellations, only accept bookings for dates you are fully confident the room will be available. If your personal circumstances change, try to find the seeker an alternative room through MigRent's host network before cancelling. The platform provides a \"Transfer Booking\" tool that lets you recommend your seeker to another verified host in your area.",
          "In genuine emergencies (property damage, family crisis), MigRent's support team can process an extenuating circumstances cancellation that does not count against your Superhost record. However, this exemption is reviewed on a case-by-case basis and is not guaranteed.",
        ],
      ...
      },
      {
        ...
        tip: "Superhosts on MigRent earn an average of 20% more per booking compared to standard hosts, thanks to higher visibility and the trust premium that comes with the badge.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Use MigRent's data-driven earnings calculator to estimate your rental income based on your suburb, room type, and occupancy assumptions.",
    ...
    sections: [
      {
        ...
        content: [
          "The MigRent earnings calculator is a free tool available to all registered hosts. You can access it from the main navigation bar or from your host dashboard. No listing is required to use the calculator, making it an ideal starting point if you are still deciding whether to host.",
          ...
          "You can adjust the occupancy slider to model different scenarios. The default setting is 85% occupancy, which reflects the average across MigRent's host network. If you are in a high-demand suburb near a university or major employer, you may realistically achieve 90 to 95% occupancy. For more regional areas, 70 to 80% may be more accurate.",
        ],
      ...
      },
      {
        ...
        content: [
          "The calculator draws on MigRent's proprietary rental data, which aggregates listing prices and actual booking values across the platform. For each suburb, you will see the median weekly price, the 25th percentile (budget end), and the 75th percentile (premium end) for each room type.",
          ...
          "Keep in mind that the data reflects MigRent's specific market, which focuses on migrants and temporary residents. These renters may have different price sensitivities compared to the broader market, so the figures may differ slightly from general rental platforms.",
        ],
        tip: "Compare the MigRent median with general rental data from Domain or Realestate.com.au. If the MigRent median is higher, it suggests strong demand from the migrant segment in that suburb.",
      },
      {
        ...
        content: [
          ...
          "The comparison also factors in MigRent's service fee for each scenario, so the earnings shown are your net take-home amounts. Higher room counts generally yield higher total income but come with additional hosting responsibilities, so weigh the financial benefit against the time commitment.",
        ],
      ...
      },
      {
        ...
        content: [
          "Income earned through MigRent is assessable income under Australian tax law and must be declared in your annual tax return. The earnings calculator includes an optional tax estimate feature that approximates your after-tax income based on your marginal tax rate.",
          "As a host, you may be eligible to claim deductions for expenses related to your rental activity. These can include a portion of your mortgage interest or rent, council rates, insurance, utilities, internet, cleaning supplies, furniture depreciation, and MigRent service fees. MigRent provides an annual income summary that you can share directly with your accountant or use for your own tax filing.",
        ],
        tip: "Keep receipts for all hosting-related expenses throughout the year. MigRent's income summary combined with your expense records makes tax time significantly easier. Consider consulting a tax professional familiar with share accommodation income.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Working holiday visa holders (subclass 417 for first-category countries, 462 for second-category countries) typically need flexible, shorter-term accommodation as they move between cities and regional areas during their stay. MigRent is well-suited for this lifestyle because listings offer weekly bookings with minimum stays as short as four weeks.",
          "Your housing rights on a working holiday visa are identical to those of any other renter. However, because working holiday makers often do not sign long-term leases, they may find themselves in informal or verbal rental arrangements. We strongly advise against informal arrangements with no written agreement. MigRent provides a standardised booking agreement for every stay, which protects both you and your host.",
          "If you are planning to do regional work to qualify for a second or third-year visa extension, research accommodation in regional areas before you arrive. Regional housing stock can be limited, and MigRent's coverage in regional centres is growing but may not yet match capital city availability. Set up alerts for your target regional areas well in advance.",
        ],
      ...
      },
      {
        ...
        content: [
          ...
          "One consideration specific to 482 visa holders is that your visa is tied to your employer. If you change jobs or your sponsorship is cancelled, your visa conditions change and this may affect your ability to maintain your rental commitment. MigRent's flexible booking model (with stays as short as four weeks) can be advantageous if your employment situation is in transition.",
        ],
      ...
      },
      {
        ...
        content: [
          ...
          "Discrimination based on nationality, race, or visa status is illegal under the Australian Human Rights Commission Act and state anti-discrimination laws. If a host or landlord refuses to rent to you because of your country of origin or visa type, you can lodge a complaint with the relevant state tribunal. MigRent has a zero-tolerance policy for discrimination and will permanently ban any host found to be engaging in discriminatory practices.",
          "You are also protected against retaliatory eviction. If you report a maintenance issue or exercise a legal right, your landlord cannot evict you in retaliation. If you believe you are being unfairly treated, MigRent's dispute resolution process and free legal referral service can help you understand your options.",
        ],
      ...
      },
      {
        ...
        content: [
          "In Australia, bonds (also called security deposits) are strictly regulated. The maximum bond a landlord can charge varies by state but is typically four weeks rent. Some states cap the bond at a lower amount for rooming or share accommodation. MigRent clearly displays the bond amount on every listing and collects it securely at the time of booking.",
          "Your bond must be held in a government-authorised bond scheme or, in the case of MigRent bookings, in MigRent's regulated trust account. The bond is not the host's money to spend. At the end of your stay, the bond is returned to you in full unless the host makes a valid claim for damages. Any disputed claims go through MigRent's mediation process before any deductions are made.",
          "When you move in, always complete the condition report thoroughly. Photograph every room, note any existing damage (marks on walls, stains on carpet, scratches on furniture), and submit the report through the MigRent app within the first 48 hours. This documentation is your primary evidence if there is a bond dispute at the end of your stay.",
        ],
        tip: "Never pay a bond directly to a host's personal bank account outside the MigRent platform. All legitimate bond payments are processed through the platform and protected by MigRent's secure holding system.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        content: [
          "If you encounter an issue during your stay that you cannot resolve directly with your host or seeker, MigRent's dispute resolution system is available to help. Common disputes include bond deductions, property condition disagreements, early termination requests, noise complaints, and breaches of house rules.",
          ...
          "Disputes should be filed within 14 days of the issue occurring or within 14 days of your checkout date for bond-related matters. Filing promptly ensures that evidence is fresh and both parties can recall the details accurately. MigRent acknowledges all dispute submissions within 24 hours.",
        ],
        tip: "Before filing a formal dispute, try sending a direct message to the other party through MigRent's messaging system. Many issues can be resolved through a calm, written conversation and it demonstrates good faith if the matter does escalate.",
      },
      {
        id: "evidence-collection",
        title: "Collecting Evidence",
        content: [
          "Strong evidence is the foundation of a successful dispute resolution. The most valuable types of evidence include timestamped photographs (use the MigRent app's photo feature which automatically adds date and location metadata), screenshots of relevant messages exchanged through the platform, your move-in condition report, and any receipts related to your claim.",
          ...
          "For disputes about behaviour or house rule violations, keep a written log with dates, times, and descriptions of each incident. If other housemates witnessed the incidents, ask them if they would be willing to provide a brief written statement. MigRent's mediation team gives significant weight to contemporaneous records over recollections shared long after the fact.",
        ],
      ...
      },
      {
        ...
        content: [
          "Once a dispute is filed and evidence has been submitted by both parties, MigRent assigns a trained mediator to the case. The mediator is an independent team member who has no prior relationship with either party. Their role is to facilitate a fair resolution, not to advocate for one side.",
          "The mediation process typically follows four stages. First, the mediator reviews all submitted evidence and correspondence from both parties. Second, the mediator may ask clarifying questions to either party via the platform's secure messaging system. Third, the mediator proposes a resolution based on the evidence and MigRent's community guidelines. Fourth, both parties are invited to accept or reject the proposed resolution.",
      ...
      },
      {
        ...
        content: [
          "MigRent's mediation can result in several outcomes depending on the nature of the dispute. For bond disputes, the mediator may order a full refund to the seeker, a partial refund, or validate the host's claim and authorise a deduction. For behavioural disputes, outcomes may include a formal warning, a requirement to follow specific corrective actions, or in serious cases, removal from the platform.",
          "If both parties accept the mediator's proposed resolution, it is considered binding and the relevant financial adjustments (bond refunds, compensation payments) are processed automatically through MigRent's payment system within three business days.",
          "If either party rejects the mediation outcome, MigRent provides information about external escalation options. These include your state's residential tenancy tribunal (such as NCAT in NSW, VCAT in Victoria, or QCAT in Queensland), local community legal centres that offer free advice, and the Australian Human Rights Commission for discrimination-related complaints. MigRent will provide a summary of the dispute and all evidence to support your external complaint if requested.",
        ],
        tip: "State tenancy tribunals are free to use and designed to be accessible without legal representation. If your dispute is not resolved to your satisfaction through MigRent mediation, do not hesitate to escalate to the relevant tribunal.",
      },
      {
        ...
        content: [
          ...
          "Both parties should communicate through the MigRent platform rather than personal messaging apps. In-platform messages are time-stamped, stored securely, and can be referenced if a dispute arises. Messages sent outside the platform cannot be verified and carry much less weight in mediation.",
        ],
