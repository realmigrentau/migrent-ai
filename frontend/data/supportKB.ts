...
const SYNONYMS: Record<string, string[]> = {
  ...
  verification: ["verify", "id check", "kyc"],
  id: ["identity", "document", "passport", "license"],
  passport: ["id", "identity", "document"],
  licence: ["license", "id", "identity"],
  visa: ["student visa", "working visa", "migrant", "subclass"],
  ...
  booking: ["reservation", "request to book", "book"],
  book: ["booking", "reservation"],
  payment: ["pay", "stripe", "charge", "billing"],
  pay: ["payment", "stripe", "charge"],
  payout: ["earnings", "withdraw", "bank transfer"],
  lease: ["tenancy", "agreement", "contract"],
  tenancy: ["lease", "agreement"],
  inspection: ["viewing", "tour", "open home"],
  pet: ["pets", "dog", "cat", "animal"],
  bills: ["utilities", "electricity", "gas", "internet", "wifi"],
  wifi: ["internet", "bills"],
  photo: ["photos", "picture", "image", "pictures"],
  photos: ["photo", "picture", "images"],
  listing: ["room", "property", "place"],
  superhost: ["badge", "trust"],
  message: ["chat", "messages", "inbox", "dm"],
  notification: ["alert", "email", "notifications"],
  password: ["login", "sign in", "reset"],
  account: ["profile", "settings"],
  delete: ["remove", "close", "deactivate"],
  emergency: ["urgent", "danger", "police", "000"],
  abn: ["tax", "abn", "ato"],
  tax: ["abn", "ato", "tfn"],
  share: ["share house", "flatmate", "housemate", "roommate"],
  flatmate: ["share", "housemate", "roommate"],
};

// ─────────────────────────────────────────────────────────────
// Help Center deep-link map - source cards become real links
// when a KB article has an authored long-form counterpart in
// frontend/lib/helpData.ts. Add entries as articles are written.
// ─────────────────────────────────────────────────────────────
export const KB_TO_HELP_SLUG: Record<string, string> = {
  "gs-001": "how-migrent-works",
  "gs-002": "how-migrent-works",
  "gs-003": "how-migrent-works",
  "gs-005": "create-your-account",
  "gs-007": "seeker-vs-owner",
  "ap-001": "complete-your-profile",
  "ap-003": "change-email-or-password",
  "vs-001": "verify-your-identity",
  "vs-002": "verify-your-identity",
  "vs-003": "verify-your-identity",
  "vs-004": "verify-your-identity",
  "lh-001": "create-your-first-listing",
  "lh-002": "create-your-first-listing",
  "lh-003": "add-photos-to-listing",
  "lh-005": "set-your-room-rules",
  "sb-001": "how-to-search-rooms",
  "sb-002": "how-to-search-rooms",
  "sb-003": "save-and-compare-listings",
  "sb-004": "how-matching-works",
  "sb-005": "request-to-book",
  "sb-006": "request-to-book",
  "sb-007": "instant-book-explained",
  "pp-001": "how-payments-work",
  "pp-002": "how-payments-work",
  "pp-003": "bond-and-deposit-rules",
  "pp-004": "cancel-a-booking",
  "vs-005": "report-a-user",
  "vs-006": "report-a-user",
  "lp-001": "bond-and-deposit-rules",
  "lp-002": "visa-and-housing-rights",
  "ts-001": "troubleshoot-login-issues",
};

export function helpSlugForArticle(id: string): string | undefined {
  return KB_TO_HELP_SLUG[id];
}
