// ─────────────────────────────────────────────────────────────
// MigRent – Comprehensive Knowledge Base
...
const articles: KBArticle[] = [
...

  {
    ...
    question: "What is MigRent and who is it for?",
    answer:
      "MigRent is an Australian rental marketplace built specifically for migrants, international students, and working professionals who are relocating to Australia. Whether you have just arrived in the country, you are planning your move from overseas, or you are a local property owner looking to rent out a room or property, MigRent connects you in a safe, verified environment.\n\nFor seekers (tenants), MigRent makes it easy to search for rooms and properties across Australia, communicate with verified hosts, complete bookings, and pay securely - all from one platform. For owners (hosts), MigRent provides the tools to list your property, verify your identity, manage booking requests, receive payments, and earn a Superhost badge.\n\nMigRent operates exclusively in Australia and all transactions are in Australian Dollars (AUD). The platform is available in eight languages to help migrants feel at home from day one.",
